...
//        if (numberHits <= 300 || numberHits > 400)
 //           continue;
    ...
    nearestDistanceSum->SetXTitle("Fractional Position p_{f} of Hits Ranked by <D_{5}>");
    nearestDistanceSum->SetYTitle("Number of entries");
    nearestDistanceSum->SetTitle("Fractional Position p_{f} of Hits Ranked by <D_{5}> for Pure & Impure Hits");
    nearestDistanceSum->GetYaxis()->SetTitleOffset(1.0);
    nearestDistanceSum->GetYaxis()->SetRangeUser(0.0, 0.07);
    nearestDistanceSum->Draw("hist");
    nearestDistanceSumImpure->SetLineColor(kRed);
    nearestDistanceSumImpure->Draw("histsame");
    ...
    c0->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/inner_track_hit_filter_cut_definition.pdf");
    ...
    nHitFiltered->Draw();
    c1->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/nHitsFiltered.pdf");
    ...
    c2->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/fractionFilteredBelongingToMuon.pdf");
    ...
    c3->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/filterPurity.pdf");
    ...
    c4->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/filterCompleteness.pdf");
    ...
    c5->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/fractionMuonHitsFiltered.pdf");
    ...
    c55->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/fractionClusterHitsFiltered.pdf");
    ...
    c555->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/fractionImpureHits.pdf");
    ...
    c6->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/fractionImpureHitsNumberHits.pdf");
    ...
    c7->SaveAs("/usera/jjd49/pandora_direction/Scripts/Figures/Filtering/fractionImpureHitsTrueEnergy.pdf");
}
